...
public class Register_SD{
	...
	public void user_enters_username_leaving_other_fields_empty() {
		hp.username_Register.sendKeys("Jyothsna1");
	}
	...
	public void user_enters_username_password_leaving_other_fields_empty() {
		hp.username_Register.sendKeys("Jyothsna1");
		hp.password_Register.sendKeys("Bq6n34@.+");
	}
	
	@When("The user enters hw9%j , Bq6n34rt , Bq6n34rt")
	public void the_user_enters_hw9_j_bq6n34_rt_bq6n34_rt() {
		hp.username_Register.sendKeys("hw9%j");
		hp.password_Register.sendKeys("Bq6n34rt");
		hp.confirmPassword_Register.sendKeys("Bq6n34rt");
	}
	...
	public void it_should_display_a_message_please_enter_a_valid_username() {
		String errorMessage =  hp.errorMessage_Register.getText();
	...
	public void the_user_enters_jyothsna1_bq6n34_dummy() {
		hp.username_Register.sendKeys("Jyothsna1");
		hp.password_Register.sendKeys("Bq6n34@.+");
		hp.confirmPassword_Register.sendKeys("dummy.@");
	}
	...
	public void the_user_enters_jyothsna1_bq6n_bq6n() {
		hp.username_Register.sendKeys("Jyothsna1");
		hp.password_Register.sendKeys("Bq6n");
		hp.confirmPassword_Register.sendKeys("Bq6n");
	}
	...
	public void the_user_enters_jyothsna1_jyothsna_jyothsna() {
		hp.username_Register.sendKeys("Jyothsna1");
		hp.password_Register.sendKeys("Jyothsna");
		hp.confirmPassword_Register.sendKeys("Jyothsna");
	}
	...
	public void the_user_enters_jyothsna_v1(Integer int1, Integer int2) {
		hp.username_Register.sendKeys("JyothsnaV1");
		hp.password_Register.sendKeys("12345678");
		hp.confirmPassword_Register.sendKeys("12345678");
	}
	...
	public void the_user_enters_jyothsna_v1_win23_jan_win23_jan() {
		hp.username_Register.sendKeys("JyothsnaV2");
		hp.password_Register.sendKeys("Win23@JanQ");
		hp.confirmPassword_Register.sendKeys("Win23@JanQ");
	}
	...
	public void it_should_display_a_message_new_account_created_you_are_logged_in_as_username() {
		String success = hp.success_Register.getText();
